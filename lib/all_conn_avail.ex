defmodule AllConnAvail do
  use MiniD3fl.Aliases

  def measure(node_num, name \\ :cifar10) when is_atom(name) do
    start = System.monotonic_time(:second)
    data_directory_path = MockHelper.prepare_data_directory!(node_num, name, "All_Conn_Avail")
    # Mockのスタート
